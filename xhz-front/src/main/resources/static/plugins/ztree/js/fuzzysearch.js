 ...
 * @param field search field if you don't want to used searchField listner
 * 
 * @returns
 */
function fuzzySearch(zTreeId, searchField, isHighLight, isExpand, field) {
    ...
    if (typeof field != 'undefined') {
        searchNodeLazy(field); //call lazy load
    } else {
    ...
    function searchNodeLazy(_keywords) {
        ...
        timeoutId = setTimeout(function () {
            if (_keywords != '' && (lastKeyword === _keywords)) {
                return;
            }
